...
$ofile1 = "Maxima/onelocusX2_maxima.txt";
open(OUT1, ">$ofile1") or die("Cannot write to $ofile1");
$ofile2 = "R/onelocusX2.R";
open(OUT2, ">$ofile2") or die("Cannot write to $ofile2");
print OUT1 "/* one X chr locus, 2-way RIL by sib mating */\n";
print OUT1 "/*  to load, use: batch(\"$ofile1\"); */\n\n";
print OUT2 "# one X chr locus, 2-way RIL by sib mating\n\n";

$ofile3 = "Latex/onelocusX2_tables.tex";
...
print OUT3 "\\textbf{\\sffamily One X chr locus, 2-way RIL by sibling mating}\n\\bigskip\n\n";
...
print OUT3 "(where \$\\text{F}_0 \\equiv AA \\times B\$)\\\\[6pt]\n";
